...
import com.jonecx.qwit.views.BottomNav.QwitBottomNavBar
import com.jonecx.qwit.views.qwitFab
import com.jonecx.qwit.views.qwitTopAppBar
import kotlinx.coroutines.flow.collect

@ExperimentalAnimationApi
@Composable
fun HomeFrame(analytics: Analytics) {
    ...
    Scaffold(
        topBar = { qwitTopAppBar() },
        floatingActionButton = { qwitFab() },
